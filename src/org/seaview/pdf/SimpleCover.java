...
/**
   ...
   @title Simple PDF Cover Page Creator
   @date 2013-03-25
 */
public class SimpleCover implements Analyzer {

	public static final long serialVersionUID = 50L;
    private static final String foaf = "http://xmlns.com/foaf/0.1/";
    private Logger logger = Logger.getLogger(SimpleCover.class.getName());
    ...
    public SimpleCover(PDFLoader pl) {
        this.loader = pl;
    }
    ...
    public static void main(String[] args) {
        if (args.length==2) {
            SimpleCover cover = new SimpleCover();
            cover.create();
            cover.loader.load(args[0]);
