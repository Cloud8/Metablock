...
import org.shanghai.data.SolrClient;
...
public class SolrTransporter implements MetaCrawl.Transporter {
    ...
    public Model read(String oid) { 
        ...
        //FileUtil.write("data/test.xml", str);
        Model mod = ModelFactory.createDefaultModel();
        try {
            InputStream is = new ByteArrayInputStream(str.getBytes("UTF-8"));
            RDFReader reader = new JenaReader();
            //reader.setProperty("WARN_UNQUALIFIED_RDF_ATTRIBUTE","EM_IGNORE");
    ...
    //    return true ; // solrClient.delete(resource);
    //} 
