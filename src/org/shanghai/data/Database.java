...
public class Database {
    ...
    private Connection getDataSourceConnection() throws SQLException {
        try {
          ...
          if (dataSource==null) {
              warning("Failed to lookup datasource.");
          } else
              connection = dataSource.getConnection();
        } catch(NamingException ex) {
             connection=null;
             warning("NamingException: no Database available.");
        } finally {
          if (connection==null) {
              warning("getDataSourceConnection: no connection.");
          }
          if (connection==null) {
              warning("tried to find a connection, but failed miserabily.");
          }
          return connection;
        }
    }
  ...
  /** Old: Uses DriverManager.
  static Connection getSimpleConnection() {
    //See your driver documentation for the proper format of this string :
    //String DB_CONN_STRING = "jdbc:mysql://localhost:3306/42_biblog";
    String DB_CONN_STRING = "jdbc:mysql://127.0.0.1:3306/42_biblog"
                          + "?useUnicode=true&characterEncoding=utf8";
    //Provided by your driver documentation. In this case, a MySql driver is used : 
    //String DRIVER_CLASS_NAME = "org.gjt.mm.mysql.Driver";
    String DRIVER_CLASS_NAME = "com.mysql.jdbc.Driver";
    String USER_NAME = "42_orpheus";
    String PASSWORD = "mary01";
